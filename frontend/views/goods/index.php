    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?= \yii\helpers\Url::to(["list","id"=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
                        <dd><a href="<?= \yii\helpers\Url::to(["list","id"=>$good->id])?>"><?=$good->goods_name?></a></dt>
                        <dd><strong>￥<?=$good->goods_price?></strong></dt>
                        <dd><a href="<?= \yii\helpers\Url::to(["list","id"=>$good->id])?>"><em>已有<?php echo rand(100,999)?>人评价</em></a></dt>
                    </dl>
                </li>
                <?php endforeach;?>
            </ul>
