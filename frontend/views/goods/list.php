...
<!-- 头部 start -->
<?php include Yii::getAlias('@app')."/views/common/header.php"?>
<!-- 头部 end-->
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?=$good->goods_name?></strong></h3>
            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$good->imgs[0]->path."?imageView2/2/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$good->imgs[0]->path."?imageView2/2/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach($good->imgs as $key=>$img):?>
                            <li class="<?=$key==0?"":"cur"?>">
                                <a class="<?=$key==0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$good->imgs[0]->path."?imageView2/2/w/350/h/350"?>',largeimage: '<?=$good->imgs[0]->path."?imageView2/2/w/800/h/800"?>'}"><img src="<?=$good->imgs[0]->path."?imageView2/2/w/50/h/50"?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=$good->goods_sn?></li>
                    <li class="market_price"><span>定价：</span><em>￥<?=$good->market_price?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong>￥<?=$good->goods_price?></strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=date("Y-m-d H:i:s",$good->create_time)?></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?= rand(100,999)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="/goods/add-cart" method="get" class="choose">
                    <input name="_csrf-frontend" type="hidden" id="_csrf-frontend" value="<?= Yii::$app->request->csrfToken ?>">
                    <input name="id" type="hidden" id="id" value="<?=$good->id?>">
                    <ul>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        <?= \backend\models\GoodsContent::findOne(['goods_id'=>$good->id])->content?>
                    </div>
                </div>
                <!-- 商品介绍 end -->
